# Práctica 5: Optimización y Hardening con Nginx
...
├── Dockerfile              # Construcción basada en Nginx con PHP
└── README.md
```
...
Se incluye un script para verificar la correcta ejecución del motor PHP y la integración FastCGI mediante la función `phpinfo()`.
...
**[victorteleanu/pps:pr5](https://hub.docker.com/repository/docker/victorteleanu/pps/tags/pr5)**